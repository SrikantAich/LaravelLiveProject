...
<div class="flex items-center justify-center min-h-screen">
    <div class="w-full max-w-4xl mx-auto bg-white rounded-lg shadow-lg dark:bg-gray-800 p-8"> <!-- Added padding for full-page look -->
        ...
        <div class="mt-6">
            <a href="{{route('Login')}}" class="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-gray-800 rounded-lg hover:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50 text-center block">
                Back to Login
            </a>
        </div>
    </div>
